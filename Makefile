...
SRC = src/func/filter.c src/func/get_column_info.c src/func/get_elem_count.c \
		...
		src/main/parse_args.c src/main/recursion.c src/main/show_folder.c \
		src/main/show_path.c src/main/sort.c src/output/output_colour.c \
...
OFILES = bin/filter.o bin/get_column_info.o bin/get_elem_count.o \
		...
		bin/parse_args.o bin/recursion.o bin/show_folder.o bin/show_path.o \
...
bin/show_path.o: $(HFILE) src/main/show_path.c
	@mkdir -p bin
	gcc $(GCCFLAGS) -c src/main/show_path.c -o bin/show_path.o
