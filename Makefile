...
#    Updated: 2019/08/02 14:42:19 by mcarter          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = src/func/filter.c src/func/get_column_info.c src/func/get_elem_count.c \
		...
		src/func/sort_cmp.c src/main/get_folder.c src/main/main.c \
...
OFILES = bin/filter.o bin/get_column_info.o bin/get_elem_count.o \
		...
		bin/get_folder.o bin/main.o bin/parse_args.o bin/recursion.o \
		bin/show_folder.o bin/sort.o bin/output_colour.o bin/output_columns.o \
		bin/output_lines.o bin/pad.o
HFILE = src/ft_ls.h
LFT = -L libft -lft
LFTA = libft/libft.a
